// Criar arquivo: app/src/main/java/com/pdm/vczap_o/group/presentation/viewmodels/GroupViewModel.kt
                    ...
                    result.onSuccess { group ->
                        _uiState.update {
                            it.copy(
                                isLoading = false,
                                currentGroup = group,
                                members = emptyList(), // Você precisa implementar a busca de membros
                                errorMessage = null
                            )
                        }
                    }.onFailure { exception ->
